...
% Need to improve
%  a) Rearrange display:
%       Fig1 sweep and LTP (synchronizing sweep and slopes and amp)
%       Initiated by buttum on Fig1
%           Fig2 adjust baseline and subtracted response
%           Fig3 calculate average
%  b) correlation between amp/slope and behavior
%           epic sensor
%           ultrasound
%  c) correlation between amp/slope and oscillations
%
%--------------------------------------------------------------------------
% display052
% Need to improve
...
function [] = evoked_response_054working
